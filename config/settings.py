...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # <-- MUEVE LA LÍNEA AQUÍ
...
DATABASES = {
    'default': {
        ...
        'NAME': 'condominio_db',        # El nombre que le diste en pgAdmin
        'USER': 'postgres',              # El usuario por defecto de PostgreSQL
        'PASSWORD': '12345678',     # La contraseña que creaste al instalar PostgreSQL
